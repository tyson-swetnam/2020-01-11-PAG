...
(function( root, factory ) {
	...
	function configure( options ) {
		...
		keyboardShortcuts['D'] = 'PDF / PowerPoint Decks';
		...
		if( config.navigationMode === 'linear' ) {
			...
			keyboardShortcuts['N , SPACE , PageDown']   = 'Next slide';
			keyboardShortcuts['P , PageUp']             = 'Previous slide';
			keyboardShortcuts['&#8592;  ,  H'] = 'Navigate left *';
			keyboardShortcuts['&#8594;  ,  L'] = 'Navigate right *';
			keyboardShortcuts['&#8593;  ,  K'] = 'Navigate up *';
			keyboardShortcuts['&#8595;  ,  J'] = 'Navigate down *';
			keyboardShortcuts['*'] = 'Press w/ shift key to skip over slide fragments';
		}

		keyboardShortcuts['Home  ,  &#8984;/CTRL &#8592;'] = 'First slide';
		keyboardShortcuts['End  ,  &#8984;/CTRL &#8594;']  = 'Last slide';
		keyboardShortcuts['B  ,  .']                       = 'Blackout';
		keyboardShortcuts['F']                             = 'Fullscreen';
		keyboardShortcuts['ESC, O']                        = 'Slide overview';
		keyboardShortcuts['X'] = 'Select Code Block';
	...
	function showHelp() {
		...
		if( config.help ) {
			...
			var html = '<p class="title">Keyboard Shortcuts</p>';
	...
	function onDocumentKeyDown( event ) {
		...
		var hardLeftShortcut = event.shiftKey && (event.keyCode == 72 || event.keyCode == 37);
		var hardRightShortcut = event.shiftKey && (event.keyCode == 76 || event.keyCode == 39);
		var hardUpShortcut = event.shiftKey && (event.keyCode == 75 || event.keyCode == 38);
		var hardDownShortcut = event.shiftKey && (event.keyCode == 74 || event.keyCode == 40);

		// Prevent all other events when a modifier is pressed
		var unusedModifier = 	!prevSlideShortcut && !firstSlideShortcut && !lastSlideShortcut &&
								!hardLeftShortcut && !hardRightShortcut && !hardUpShortcut && !hardDownShortcut &&
